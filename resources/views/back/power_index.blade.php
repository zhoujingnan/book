    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;">
  		  		<a href="{{url('backpower/add')}}" target="mainFrame" onFocus="this.blur()" class="add">新增权限名</a>
  		 </td>
  		</tr>
	</table>
    </td>
    ...
    <td align="left" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
          <tr>
            ...
            <th align="center" valign="middle" class="borderright">权限名</th>
            <th align="center" valign="middle" class="borderright">控制器名</th>
            <th align="center" valign="middle">操作</th>
          </tr>
          @foreach($arr as $key =>$val)
          <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
            <td align="center" valign="middle" class="borderright borderbottom">
              <input type="checkbox" class="box" value="{{$val['p_id']}}">
            </td>
            <td align="center" valign="middle" class="borderright borderbottom">{{$val['p_id']}}</td>
            <td align="center" valign="middle" class="borderright borderbottom">{{$val['p_name']}}</td>
             <td align="center" valign="middle" class="borderright borderbottom">{{$val['cname']}}</td>
            <td align="center" valign="middle" class="borderbottom">
              <a href="{{url('backpower/up',['p_id'=>$val['p_id']])}}" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
              <span class="gray">&nbsp;|&nbsp;</span>
              <a href="{{url('backpower/del',['p_id'=>$val['p_id']])}}" onFocus="this.blur()" class="add">删除</a>
            </td>
          </tr>
          @endforeach
        </table>
 ...
 //批删
    $(document).on("click",".pidel",function(){
      if(confirm("are you sure delete?")){
        ...
        $.ajax({
          type:'get',
          url:"<?php echo url('backpower/pidel')?>",
          data:{str:s},
          success:function(msg){
            console.log(msg)
            if(msg==1){
              location.href="<?php echo url('backpower/index')?>"
            }
          }
        })        
      }
